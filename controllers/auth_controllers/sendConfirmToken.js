...
function sendConfirmToken(email, login, password) {
...
function generateAccessToken(email) {
    return jwt.sign({ email }, tokenOptions.secret, { expiresIn: tokenOptions.expire_sec });
}

module.exports = sendConfirmToken;
